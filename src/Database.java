...
//skapar en lista med alla objekt
    public List<QuestionsAndAnswers> CreateQuestionsAndAnswers (){
         ...
         questionsAndAnswersList.add( new QuestionsAndAnswers("Hur många säsonger har serien La casa de papel?","Frukter", "Städer", "Sötsaker", "Sötsaker", Categories.TV_SERIER)); //Svaren behöver nog rättas här
...
//metod som gör att man kan hämta frågor och svar enbart för en viss specifik kategori
